Ext.define('rewadmin.model.GuiaCabecera', {
    ...
    fields: [{
        ...
        type: 'int',
        useNull: true
    }, 'fecha', {name: 'tipo_documento_id', type: 'int'}, {name: 'tipo_documento_name', persist: false}, 'serie', 'numero', 
    {name: 'tipo_operacion_id', type: 'int'}, {name: 'tipo_operacion_name', persist: false}, 
    {name: 'cliente_proveedor_id', type: 'int'}, {name: 'cliente_proveedor_name', persist: false}, 'documento_relacionado',
