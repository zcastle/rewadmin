Ext.define('rewadmin.controller.OrdenProduccion', {
    extend: 'Ext.app.Controller',
    models: ['OrdenProduccion','OrdenProduccionDetalle'],
    stores: ['OrdenProduccion','OrdenProduccionDetalle'],
    refs: [{
		ref: 'Viewport',
		selector: 'viewport'
	},{
		ref: 'form',
		selector: '#frmCabeceraGuiaProduccion'
	},{
		ref: 'grid',
		selector: 'GridOrdenProduccion'
	}],
	rowEditing: null,
    init: function() {
		this.control({
	...
	onGridAfterRender: function() {
		this.getForm().loadRecord(Ext.create('rewadmin.model.OrdenProduccion', {
			'fechahora': new Date(),
	...
	btnAgregarOK: function(btn) {
		console.log('btnAgregarOK');
		var win = Ext.widget('winproductobuscar');
